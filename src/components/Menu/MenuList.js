...
const MenuList = ({ onLoaded, setActiveCategory }) => {
  ...
  return (
    <div ref={menuRef} className="pb-32 px-4 md:px-8 max-w-[1600px] mx-auto lg:px-12 overflow-x-hidden bg-white">
      
      {/* SEARCH BAR SECTION */}
      <div className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm py-2 mb-6 border-b border-gray-100">
      ...
      {categories.map((cat) => {
        ...
        return (
          <section key={cat.id} id={cat.id} className="category-section mt-10 scroll-mt-32">
